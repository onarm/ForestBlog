            ...
            <div class="horizontal-align">
                ...
                <div class="layui-input-block">
                    <div class="layui-unselect">
                        <input type="radio" name="pageStatus" value="1" title="显示" ${page.pageStatus==1 ? 'checked' : ''}>
                        <i class="layui-anim layui-icon layui-icon-radio"></i>
                        <span>显示</span>
                    </div>
                    <div class="layui-unselect">
                        <input type="radio" name="pageStatus" value="0" title="隐藏" ${page.pageStatus==0 ? 'checked' : ''}>
                        <i class="layui-anim layui-icon layui-icon-radio"></i>
                        <span>隐藏</span>
                    </div>
                </div>
